...
namespace HomeManger.Data
{
    public abstract class SqlHelper
    {
        ...
        public static string ExecuteStringXmlReader(SqlConnection connection, SqlTransaction? trans, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            ...
            return trans == null ? ExecuteStringXmlReader(trans: trans, cmdType, cmdText, commandParameters) : ExecuteStringXmlReader(connection, cmdType, cmdText, commandParameters);
